...
%>
                                            <tr>
                                                <th scope="row">
                                        <div class="p-2">
                                            <img src="<%=p.getImg()%>" alt="" width="70" class="img-fluid rounded shadow-sm">
                                            <div class="ml-3 d-inline-block align-middle">
                                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block"><%=p.getName()%></a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                            </div>
                                        </div>
                                        </th>
                                        ...
                                        <td class="align-middle">
                                            <a href="SubProduct?productID=<%=p.getId()%>"><button class="btnSub">-</button></a> 
                                            <strong><%=p.getQuatity()%></strong>
                                            <a href="cart?productID=<%=p.getId()%>"><button class="btnAdd">+</button></a>
                                        </td>
                                        <td class="align-middle"><a href="RemoveProductCart?id=<%=p.getId()%>" class="text-dark">
