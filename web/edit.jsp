<%-- 
    Document   : edit
    Created on : Mar 6, 2022, 2:23:34 PM
    Author     : Minh Hoàng
--%>
                        ...
                        <form action="EditControl" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="<%=p.getProductID()%>" name="id" type="text" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input value="<%=p.getProductName()%>" name="name" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-select" aria-label="Default select example">
                                        ...
                                        %>
                                        <option value="<%=c.getCatagoryID()%>" <%=p.getCatagoryID().equals(c.getCatagoryID())?"selected":""%> ><%=c.getCatagoryName()%></option>
                                        <%      }
                            ...
                            <div class="modal-footer">
                                <a href="ManagerProduct" type="submit" class="btn btn-success">Back</a>
